...
+function () {
    ...
    var Alert = function ($) {
        ...
        var Alert = function () {
            ...
            Alert.prototype._removeElement = function _removeElement(element) {
                ...
                if (!Util.supportsTransitionEnd() || !$(element).hasClass(
                        ClassName.FADE)) {
        ...
        var Button = function () {
            ...
            Button.prototype.toggle = function toggle() {
                ...
                if (rootElement) {
                    ...
                    if (input) {
                        if (input.type === 'radio') {
                            if (input.checked && $(this._element).hasClass(
                                    ClassName.ACTIVE)) {
    ...
    var Carousel = function ($) {
        ...
        var Carousel = function () {
            ...
            Carousel.prototype._addEventListeners = function _addEventListeners() {
                ...
                if (this._config.pause === 'hover' && !('ontouchstart'
            ...
            Carousel.prototype._getItemByDirection = function _getItemByDirection(direction,
                activeElement) {
            ...
            Carousel.prototype._setActiveIndicatorElement = function _setActiveIndicatorElement(element) {
                if (this._indicatorsElement) {
                    $(this._indicatorsElement).find(
                        Selector.ACTIVE).removeClass(ClassName.ACTIVE);
            ...
            Carousel.prototype._slide = function _slide(direction, element) {
                ...
                if (Util.supportsTransitionEnd() && $(this._element).hasClass(
                        ClassName.SLIDE)) {
        ...
        var Collapse = function () {
            ...
            Collapse.prototype.show = function show() {
                ...
                if (this._triggerArray.length) {
                    $(this._triggerArray).removeClass(ClassName.COLLAPSED).attr(
                        'aria-expanded', true);
                }
            ...
            Collapse._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function () {
                    var $this = $(this);
                    var data = $this.data(DATA_KEY);
                    var _config = $.extend({}, Default,
                        $this.data(), (typeof config === 'undefined'
    ...
    var Dropdown = function ($) {
            ...
            Dropdown._clearMenus = function _clearMenus(event) {
                ...
                for (var i = 0; i < toggles.length; i++) {
                    ...
                    if (event && (event.type === 'click'
                            ...
                            || event.type === 'focusin') && $.contains(parent,
                            event.target)) {
                        continue;
                    }
        ...
        $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE,
            ...
            + Event.FOCUSIN_DATA_API, Dropdown._clearMenus).on(
            Event.CLICK_DATA_API, Selector.DATA_TOGGLE,
            Dropdown.prototype.toggle).on(Event.CLICK_DATA_API,
    ...
    var Modal = function ($) {
        ...
        var Modal = function () {
            ...
            Modal.prototype._enforceFocus = function _enforceFocus() {
                ...
                .on(Event.FOCUSIN, function (event) {
                    if (document !== event.target && _this12._element
                        !== event.target && !$(_this12._element).has(
                            event.target).length) {
            ...
            Modal._jQueryInterface = function _jQueryInterface(config,
                ...
                return this.each(function () {
                    var data = $(this).data(DATA_KEY);
                    var _config = $.extend({}, Modal.Default,
                        $(this).data(), (typeof config === 'undefined'
                        ? 'undefined' : _typeof(config)) === 'object'
                        && config);
        ...
        $(document).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE,
            function (event) {
                ...
                var config = $(target).data(DATA_KEY) ? 'toggle' : $.extend({},
    ...
    var ScrollSpy = function ($) {
        ...
        var ScrollSpy = function () {
            ...
            ScrollSpy.prototype.refresh = function refresh() {
                ...
                !== this._scrollElement.window ? OffsetMethod.POSITION
                    : OffsetMethod.OFFSET;
            ...
            ScrollSpy.prototype._activate = function _activate(target) {
                ...
                if ($link.hasClass(ClassName.DROPDOWN_ITEM)) {
                    ...
                    $link.parents(Selector.LI).find('> '
                        + Selector.NAV_LINKS).addClass(ClassName.ACTIVE);
                }
    ...
    var Tab = function ($) {
        ...
        var Tab = function () {
            ...
            Tab.prototype._transitionComplete = function _transitionComplete(element,
        ...
        var Tooltip = function () {
            ...
            Tooltip.prototype.show = function show() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    if (Util.supportsTransitionEnd() && $(this.tip).hasClass(
                            ClassName.FADE)) {
                        this._isTransitioning = true;
            ...
            Tooltip.prototype.setElementContent = function setElementContent($element,
                content) {
                var html = this.config.html;
                if ((typeof content === 'undefined' ? 'undefined' : _typeof(
                        content)) === 'object' && (content.nodeType
                        || content.jquery)) {
                ...
                triggers.forEach(function (trigger) {
                    if (trigger === 'click') {
                        $(_this24.element).on(_this24.constructor.Event.CLICK,
                            _this24.config.selector, function (event) {
                        ...
                        $(_this24.element).on(eventIn, _this24.config.selector,
                            function (event) {
                                return _this24._enter(event);
                            }).on(eventOut, _this24.config.selector,
                            function (event) {
        ...
        var Popover = function (_Tooltip) {
            ...
            Popover._jQueryInterface = function _jQueryInterface(config) {
                return this.each(function () {
                    var data = $(this).data(DATA_KEY);
                    var _config = (typeof config === 'undefined' ? 'undefined'
                        : _typeof(config)) === 'object' ? config : null;
