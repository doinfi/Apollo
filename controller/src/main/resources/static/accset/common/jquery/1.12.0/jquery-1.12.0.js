                        ...
                        for (i = 0; i < delegateCount; i++) {
                            ...
                            if (matches[sel] === undefined) {
                                matches[sel] = handleObj.needsContext ? jQuery(
                                    sel, this).index(cur) > -1 : jQuery.find(
            ...
            return this.each(function () {
                ...
                if (type === "string") {
                    ...
                    jQuery.attr(this, "class",
                        className || value === false ? "" : jQuery._data(this,
                            "__className__") || ""
                    );
                }
            });
 ...
 */
    ...
    jQuery.expr.filters.hidden = function (elem) {
        ...
        return support.reliableHiddenOffsets() ? ( elem.offsetWidth <= 0
            && elem.offsetHeight <= 0 &&
            !elem.getClientRects().length ) : filterHidden(elem);
    };
    ...
    jQuery.fn.load = function (url, params, callback) {
        ...
        if (self.length > 0) {
            jQuery.ajax({
                ...
                self.each(function () {
                    callback.apply(self, response || [jqXHR.responseText,
                        status, jqXHR]);
                });
            });
        }
