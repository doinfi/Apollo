...
// Expose support vars for convenience
	...
	---------------------------------------------------------------------- */
                ...
                sortOrder = hasCompare ? function (a, b) {
                    ...
                    if (!aup || !bup) {
                        return a === document ? -1 : b === document ? 1 : aup
                            ? -1 : bup ? 1 : sortInput ? ( indexOf(sortInput, a)
            ...
            if (!rneedsContext.test(selectors)) {
                for (; i < l; i++) {
                    for (cur = this[i]; cur && cur !== context;
                        ...
                        if (cur.nodeType < 11 && ( targets ? targets.index(cur)
                                > -1 : // Don't pass non-elements to Sizzle
                                cur.nodeType === 1 &&
                        ...
                        return jQuery.Deferred(function (newDefer) {
                            ...
                            tuples[0][3].add(
                                resolve(
                                    0,
                                    newDefer,
                                    jQuery.isFunction(onProgress) ? onProgress
                                        : Identity,
                                    newDefer.notifyWith
                                )
                            );
                            ...
                            tuples[1][3].add(
                                resolve(
                                    0,
                                    newDefer,
                                    jQuery.isFunction(onFulfilled) ? onFulfilled
                                        : Identity
                                )
                            );
                            ...
                            tuples[2][3].add(
                                resolve(
                                    0,
                                    newDefer,
                                    jQuery.isFunction(onRejected) ? onRejected
                                        : Thrower
                                )
                            );
                        }).promise();
            ...
            get: function (elem, computed, extra) {
                if (computed) {
                    ...
                    ( !elem.getClientRects().length
                        || !elem.getBoundingClientRect().width ) ? swap(elem,
                        cssShow, function () {
        ...
        function (i, name) {
            ...
            attrHandle[name] = function (elem, name, isXML) {
                ...
                if (!isXML) {
                    ...
                    ret = getter(elem, name, isXML) != null ? lowercaseName
                        : null;
                ...
                if (type === "string") {
                    ...
                    if (this.setAttribute) {
                        this.setAttribute("class",
                            className || value === false ? "" : dataPriv.get(
                                this, "__className__") || ""
                        );
                    }
                }
            ...
            select: {
                ...
                set: function (elem, value) {
                    ...
                    while (i--) {
                        ...
                        if (option.selected =
                                jQuery.inArray(
                                    jQuery.valHooks.option.get(option), values)
                                > -1
                        ) {
                            optionSet = true;
                        }
