package com.yf.coros.common.utils.primary;
...
public class YFPrimaryKeyUtils {
     ...
     * 序列号占14位
     */
    private static final Long SEQUENCE_BITS = ApplicationContants.PRIMARY_KEY_SEQUENCE_BITS;
    /**
     * 模块号占7位
     */
    private static final Long MODE_BITS = ApplicationContants.PRIMARY_KEY_MODE_BITS;
    /**
     * 机器码或者服务实例编号占7位
     */
    private static final Long WORKER_ID_BITS = ApplicationContants.PRIMARY_KEY_WORKER_BITS;
    /**
