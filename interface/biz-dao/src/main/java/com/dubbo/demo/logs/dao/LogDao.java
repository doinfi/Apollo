package com.dubbo.demo.logs.dao;
...
public interface LogDao {
     ...
     * @return 返回logDTO对象
     */
    LogDTO addOperateLog(LogDTO logDTO);
     ...
     */
    List<LogDTO> findOperateLogs(int userId, Date startTime, Date endTime);
     ...
     */
    LogDTO addErrorLog(LogDTO logDTO);
     ...
     * @return 输出参数:用户操作日志列表<br>
     */
    List<LogDTO> findErrorLogs(int userId, Date startTime, Date endTime);
     ...
     * @return 日志文件地址信息<br>
     */
    List<LogDTO> findLogFilesByLogId(Long logId, Integer logType);
     ...
     */
    void addLogFiles(List<LogFileDTO> logFiles);
